 ...
 * the hook dispatcher. It registers no step definitions and knows nothing
 * about Drupal: the entity lifecycle lives in 'DrupalRawContext' and the web
 * helpers in 'WebRawContext'.
 *
 * Extend this directly only to build a context out of neither half's
 * plumbing.
 *
