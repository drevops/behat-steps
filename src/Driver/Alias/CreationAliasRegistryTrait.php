...
trait CreationAliasRegistryTrait {
   ...
   *
   * @var array<string, array<string, \DrevOps\BehatSteps\Driver\Alias\CreationAliasInterface>>
   */
   ...
   *
   * @param \DrevOps\BehatSteps\Driver\Alias\CreationAliasInterface $alias
   ...
   *
   * @return array<string, \DrevOps\BehatSteps\Driver\Alias\CreationAliasInterface>
