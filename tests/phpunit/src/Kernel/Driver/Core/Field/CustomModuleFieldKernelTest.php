 ...
 *
 * The 'mysite_field_test' fixture module ships two field types the driver has
 ...
 *
 *  - 'mysite_test_scalar' (plain-scalar columns) rides 'DefaultHandler' and
 *    round-trips through real storage intact.
 *  - 'mysite_test_reference' (an entity-reference target column) is refused at
...
class CustomModuleFieldKernelTest extends FieldHandlerKernelTestBase {
  ...
  public function testScalarFieldWithoutHandlerRoundTrips(): void {
    $this->attachField('field_scalar', 'mysite_test_scalar');
  ...
  public function testReferenceFieldWithoutHandlerIsRejected(): void {
    $this->attachField('field_ref', 'mysite_test_reference');
