...
namespace DrevOps\BehatSteps\Tests\Driver\Unit\Core\Alias;

use DrevOps\BehatSteps\Driver\Alias\PreCreateAliasInterface;
use DrevOps\BehatSteps\Driver\Core\Alias\AuthorAlias;
use DrevOps\BehatSteps\Driver\Entity\EntityStub;
use DrevOps\BehatSteps\Driver\Exception\CreationAliasResolutionException;
use DrevOps\BehatSteps\Tests\Driver\Unit\Fixtures\FakeUser;
