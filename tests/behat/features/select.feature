Feature: Ensure SelectTrait works.
  ...
  Scenario: Assert that a select has/has not an option
    ...
    Then the option "DUMMY-COUNTRY" should not exist within the select element "site_default_country"
  ...
  Scenario: Assert that a select option is selected.
    ...
    Then the option "UTC" should be selected within the select element "date_default_timezone"
  ...
  Scenario: Assert that a select option is not selected
    ...
    Then the option "Australia/Sydney" should not be selected within the select element "date_default_timezone"
