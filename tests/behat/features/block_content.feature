...
Feature: Check that BlockContentTrait works
  ...
  Scenario: Create, manage, and verify custom block content entities
    ...
    Given the custom block type "basic" exists
    And the following "basic" custom blocks do not exist:
      | [TEST] Custom Block 1 |
      | [TEST] Custom Block 2 |
    And the following "basic" custom blocks exist:
      | info                  | status | body                  |
    ...
    When I edit the "basic" custom block with description "[TEST] Custom Block 1"
  ...
  Scenario: Edit a custom block content
    ...
    When I edit the "basic" custom block with description "[TEST] Editable Block"
