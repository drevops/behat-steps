...
| `Then I( should) see the :selector element with a(n) :attribute attribute containing :value`                                 | Assert an element with selector and attribute with a value exists, matching a wildcard pattern. |
