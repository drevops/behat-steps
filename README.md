...
| `When I configure the visibility condition :condition for the block with label :label`                                       | Set a visibility condition for a block.                                                                     |
...
| `Given block_content_type :type with description :description exists`                                                        | Assert that a block content type exists.                                                                    |
| `Given block_content :name of block_content_type :type exists`                                                               | Assert that a block content with the given name and type exists.                                            |
...
| `When I edit :type block_content_type with description :info`                                                                | Navigate to specified block content type edit page.                                                         |
| &nbsp;                                                                                                                       |                                                                                                             |
